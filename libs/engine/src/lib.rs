...
//! | [`AgentEvent`] | Streaming events — Token, ToolCall, ToolSuccessful, ToolFailure, Done, ... |
...
pub use agent::{
    Agent, AgentError, AgentEvent, CallOrigin, InterveneRequest, InterveneResponse, RunOutcome,
};
